    ...
    // player 2 == green
           ...
           int edges_left = 0;
            ...
            for(int b=0;b<limit;b++) {
                ...
                System.out.println("chain data (outside method) for chain "+a+" box "+b+" is "+chainData[a][b].getCol()
         ...
         for(int a=0;a<limit;a++) {
            for(int b=0;b<limit;b++) {
                ...
                System.out.println("pot. chain data (outside method) for pot. chain "+a+" box "+b+" is "+pchainData[a][b].getCol()
